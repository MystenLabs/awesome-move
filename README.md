...
- [ChainX](https://github.com/chainx-org/ChainX) - BTC's second-layer smart contract network has already supported WASM and EVM virtual machines, and is supporting MoveVM (in [mainnet](https://scan.chainx.org)).
